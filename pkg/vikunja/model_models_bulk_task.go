...
// checks if the ModelsBulkTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsBulkTask{}

// ModelsBulkTask struct for ModelsBulkTask
...
func (o ModelsBulkTask) ToMap() (map[string]interface{}, error) {
...
type NullableModelsBulkTask struct {
	value *ModelsBulkTask
	isSet bool
}

func (v NullableModelsBulkTask) Get() *ModelsBulkTask {
	return v.value
}

func (v *NullableModelsBulkTask) Set(val *ModelsBulkTask) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsBulkTask) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsBulkTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsBulkTask(val *ModelsBulkTask) *NullableModelsBulkTask {
	return &NullableModelsBulkTask{value: val, isSet: true}
}

func (v NullableModelsBulkTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsBulkTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
